...
export const EXPERIENCE_COMPANIES: ExperienceCompany[] = [
  ...
  },
  {
    ...
    companyDates: "Jul 2024 — Jan 2025",
    roles: [
      {
        role: "Customer Success Lead",
        dates: "Jul 2024 — Jan 2025",
        summary:
          "Led Customer Success at group level, building the function beyond Zervant and helping align customer operations across Ageras's wider organisation.",
        bullets: [
  ...
  {
    company: "Zervant",
    companyDates: "Feb 2018 — Jul 2024",
    ...
    roles: [
      {
        ...
        summary:
          "Led Customer Success across 12 core markets and six languages, combining team leadership, customer lifecycle design, and operational development in a changing organisation.",
        bullets: [
      ...
      },
      {
        ...
        summary:
          "Managed the French-speaking customer base (100k+ users), focusing on onboarding, activation, and helping small businesses get value from the product.",
        bullets: [
      ...
      },
      {
        ...
        summary:
          "Provided first-line support for French-speaking customers, helping troubleshoot issues and guide them through the product.",
        bullets: [
...
export const EXPERIENCE = {
  title: "Experience",
  intro:
    "Roles, responsibilities, and the work I’ve done across Customer Success, support, operations, and SaaS growth.",
  filterLabels: [
    "Overview",
    "Customer success",
    "Support",
